...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            ...
            return "<li><span class=\"pageinfo\">total: <strong>1</strong>page<strong>".$this->TotalResult."</strong>TotalResult</span></li>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<li><span class=\"pageinfo\">total: <strong>0</strong>page<strong>".$this->TotalResult."</strong>TotalResult</span></li>\r\n";
        }
        $purl = $this->GetCurUrl();
        $maininfo = "<li><span class=\"pageinfo\">total: <strong>{$totalpage}</strong>page<strong>".$this->TotalResult."</strong>条</span></li>\r\n";
        ...
        if($this->PageNo != 1)
        {
            ...
            $indexpage="<li><a href='".str_replace("{page}",1,$tnamerule)."'>index</a></li>\r\n";
        }
        else
        {
            $indexpage="<li>index</li>\r\n";
        }
